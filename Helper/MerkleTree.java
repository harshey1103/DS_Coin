...
public class MerkleTree {
  ...
  public List<Pair<String, String>> pathtoroot(int doc_idx) {
    ArrayList<Pair<String, String>> path = new ArrayList<Pair<String, String>>();
    int j = doc_idx;
    int r = this.numdocs/2;
    ...
    while (curr != this.rootnode) {
      curr = curr.parent;
      path.add(new Pair<String, String>(curr.left.val, curr.right.val));
    }
    Pair<String, String> pair = new Pair<String, String>(curr.val, null);
    path.add(pair);
    return path;
  }
}
